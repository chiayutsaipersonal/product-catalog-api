...
module.exports = db => {
  ...
  // contacts and order relationships
  ...
  db.PurchaseOrders.belongsToMany(
    db.Products,
    injectOptions('purchaseOrderId', 'id', db.OrderDetails)
  )
  db.Products.belongsToMany(
    db.PurchaseOrders,
    injectOptions('productId', 'id', db.OrderDetails)
  )
  db.OrderDetails.belongsTo(
    db.PurchaseOrders,
    injectOptions('purchaseOrderId', 'id')
  )
  db.PurchaseOrders.hasMany(
    db.OrderDetails,
    injectOptions('purchaseOrderId', 'id')
  )
  ...
  db.Series.hasMany(
    db.Series,
    Object.assign({ as: 'childSeries' }, injectOptions('parentSeriesId', 'id'))
  )
  ...
  logging.console('Table relationships established')
